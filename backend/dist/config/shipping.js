...
exports.computeShippingPrice = computeShippingPrice;
...
exports.default = (0, config_1.registerAs)('shipping', () => {
 ...
 */
function computeShippingPrice(input) {
    ...
    if (FEATURE_TARIFF_URBAN_V2) {
        const dPlazaKm = haversineKm({ lat: PLAZA_LAT, lng: PLAZA_LNG }, { lat: destLat, lng: destLng });
    ...
    // Clásico (fallback)
    const dStoreKm = haversineKm({ lat: STORE_LAT, lng: STORE_LNG }, { lat: destLat, lng: destLng });
