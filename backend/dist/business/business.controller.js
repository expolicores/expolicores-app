...
const apply_business_dto_1 = require("./dto/apply-business.dto");
let BusinessController = class BusinessController {
    constructor(service) {
        this.service = service;
    }
    async apply(user, _dto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, apply_business_dto_1.ApplyBusinessDto]),
    __metadata("design:returntype", Promise)
], BusinessController.prototype, "apply", null);
__decorate([
    (0, common_1.Get)('me'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    ...
    __metadata("design:returntype", Promise)
], BusinessController.prototype, "me", null);
