...
const business_admin_controller_1 = require("./business.admin.controller");
...
exports.BusinessModule = BusinessModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [business_controller_1.BusinessController, business_admin_controller_1.AdminBusinessController],
    })
], BusinessModule);
