...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 2, description: 'Cantidad del producto' }),
    (0, class_validator_1.IsInt)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 123, description: 'ID de la dirección de entrega' }),
    (0, class_validator_1.IsInt)(),
    (0, class_validator_1.IsPositive)(),
    __metadata("design:type", Number)
