...
export type RootStackParamList = {
  ...
  Profile: undefined;
  Favorites: undefined;
  Locker: undefined; // ⬅️ NUEVO: casillero B2B
  MyOrders: undefined;
  ...
  AdminPromotions: undefined; // listado de promociones (admin)
  PromoDetail: { promoId: string } | { promo?: any }; // detalle/edición de una promo
  ...
  // Legal / privacidad
  Legal: undefined;
  PrivacyAccount: undefined; // screen "Privacidad y cuenta"
};
